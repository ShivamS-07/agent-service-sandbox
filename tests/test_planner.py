...
stock_ids = stock_identifier_lookup_multi(stock_strs=["Meta", "Apple", "Microsoft"])  # Look up stock identifiers for Meta, Apple, and Microsoft
    ...
    def test_validate_construct_plan(self):
        ...
        example_input = [
            ...
            ParsedStep(
                output_var="summary",
                function="summarize_texts",
                arguments={"texts": "news_descriptions"},
