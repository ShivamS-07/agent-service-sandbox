            ...
            TextOutput(
                ...
                citations=[
                    CitationOutput(
                        ...
                        name="forbes.com",
                        metadata="https://www.forbes.com/sites/jenamcgregor/2024/06/10/former-google-exec-laszlo-bocks-next-startup-the-productivity-theater-problem-and-more/",  # noqa
                    )
                ],
            ...
            TextOutput(
                ...
                citations=[
                    CitationOutput(
                        ...
                        metadata="https://www.businessinsider.com/ceo-harder-to-buy-apple-watch-christmas-2023-12",  # noqa
                    )
                ],
            ...
            TextOutput(
                ...
                citations=[
                    ...
                    CitationOutput(
                        ...
                        citation_type=CitationType.LINK,
                        name="businessinsider.com",
                        metadata="https://www.businessinsider.com/apple-to-allow-iphone-text-scheduling-ios-software-update-2024-6",  # noqa
                    ),
                ],
                val="Test text",
                score=None,
