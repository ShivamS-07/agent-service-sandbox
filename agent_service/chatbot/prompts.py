...
INITIAL_POSTPLAN_INCOMPLETE_SYS_PROMPT_STR = (
    ...
    "You should tell the client that you have an initial plan (do not use verbiage that suggests "
    "you have 'finished' or 'completed' anything), but you weren't able to fully satisfy their request. "
    "Briefly mention any failures to satisfy the client's needs. If you can do this concisely while still "
    "quoting the client's request directly, you must do so, otherwise you should paraphrase."
