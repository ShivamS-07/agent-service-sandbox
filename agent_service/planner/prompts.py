...
FIRST_ACTION_DECIDER_SYS_PROMPT_STR = (
    ...
    "\n- Action must be 'Refer' when the client request is related to FAQ, HOW-TO, and general questions about the tools. "
    "For example, questions or requests like 'what databases do you use?' or 'how do you get your data?' "
    "'How to use X', 'What is the purpose of X', 'how to add a new stock', etc. "
