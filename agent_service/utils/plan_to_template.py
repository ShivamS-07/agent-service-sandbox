...
TEMPLATE_FROM_PLAN_SYS_PROMPT = Prompt(
    ...
    template=(
        ...
        "\n- Use <code> for specific inputs such as topics, date ranges, sectors, index names, etc. "
        "\n- If user mentions a portfolio, either by mentioning 'my portfolio' or similar terms, "
        "or a portfolio ID, or a specific portfolio name, "
        'use <option-dropdown type="portfolio"></option-dropdown> tag in your prompt. '
        "\n- If user mentions a watchlist, either by mentioning 'my watchlist' or similar terms, "
