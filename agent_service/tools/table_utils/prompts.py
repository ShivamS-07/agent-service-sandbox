...
When doing filtering involving multiple months, quarters, or years using relative time periods such as
last N months,quarters,years, you must never, ever include the current month, quarter, or year. Even if
today is the last day of the month/quarter/year, you must always jump back to the previous 
month/quarter/year.
For example, if you are filtering on the last 3 months and it is 2024-11-30, the last 3 months
are 2023-08, 2023-09, and 2023-10.

If you are going to do a complex filter using pd.filter, you must declare the function using def
(no lambda functions, and all variables used inside your custom filter function must be passed
into the function, variables declared outside the function will not be visible, your code will
crash and you will be fired. 
