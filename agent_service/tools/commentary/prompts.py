...
GET_COMMENTARY_INPUTS_DESCRIPTION = (
    ...
    "\n- 'universe_name' is the name of the universe or index that is used to write a commentary. "
    "If client wants a commentary on specific index or ETF, 'universe_name' MUST be the name of the index or ETF. "
    "If client mentioned 'market' in their query or wants to know about market performance/updates, "
    "and didn't mention any specific portfolio, "
...
WRITE_COMMENTARY_DESCRIPTION = (
    ...
    "for due diligence. If you are at all unsure, you should use the summarize_texts tool, not this tool. "
    ...
    "If you need multiple outputs, instead use the summarize_texts tool multiple times."
